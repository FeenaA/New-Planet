...
public class StartTransportPeople : MonoBehaviour
{
    ...
    public void ClosePressed()
    {
        ...
        string SceneName = SceneName = SceneManager.GetActiveScene().name;
        if (SceneName == "Research") { SceneManager.LoadScene("Game"); }
        else if (SceneName == "Game") { Object.Destroy(gameObject); }
    }
